...
echo -e "${YELLOW}AWS_REGION"
echo -e "${YELLOW}ENVIRONMENT"
echo -e "${YELLOW}TERRAFORM_STATE_BUCKET"
echo -e "${YELLOW}S3_BUCKET_LANDING"
echo -e "${YELLOW}S3_BUCKET_RAW"
echo -e "${YELLOW}S3_BUCKET_CURATED"
echo -e "${YELLOW}S3_BUCKET_READY"
